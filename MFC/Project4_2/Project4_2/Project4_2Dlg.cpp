...
// Project4_2Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "Project4_2.h"
#include "Project4_2Dlg.h"
...
// CProject4_2Dlg 대화 상자



CProject4_2Dlg::CProject4_2Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CProject4_2Dlg::IDD, pParent)
	, m_strYear(_T(""))
	, m_strMonth(_T(""))
	, m_strDay(_T(""))
	, m_strAMPM(_T(""))
...
void CProject4_2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CProject4_2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_COMMAND(IDC_RADIO_12, &CProject4_2Dlg::OnRadio12)
	ON_COMMAND(IDC_RADIO_24, &CProject4_2Dlg::OnRadio24)
	ON_BN_CLICKED(IDC_CHECK_YEAR, &CProject4_2Dlg::OnClickedCheckYear)
	ON_BN_CLICKED(IDC_CHECK_HOUR, &CProject4_2Dlg::OnClickedCheckHour)
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BUTTON_HELP, &CProject4_2Dlg::OnClickedButtonHelp)
END_MESSAGE_MAP()


// CProject4_2Dlg 메시지 처리기

BOOL CProject4_2Dlg::OnInitDialog()
{
...
void CProject4_2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CProject4_2Dlg::OnQueryDragIcon()
{
...
void CProject4_2Dlg::OnClickedCheckYear()
{
...
void CProject4_2Dlg::OnClickedCheckHour()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CProject4_2Dlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CProject4_2Dlg::OnClickedButtonHelp()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
